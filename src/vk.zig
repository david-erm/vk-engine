...
pub const table = struct {
	pub const global = struct {		pub var vkCreateInstance: pfn.vkCreateInstance = undefined;
	...
	pub const instance = struct {		pub var vkDestroyInstance: pfn.vkDestroyInstance = undefined;
	...
	pub const device = struct {		pub var vkGetDeviceProcAddr: pfn.vkGetDeviceProcAddr = undefined;
